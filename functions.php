...
function webbird_theme_setup(){
    load_theme_textdomain('derioolkrak', get_template_directory() . '/languages');
}
...
function webbird_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
	    'medium-square' => __( 'Medium square', 'derioolkrak' ),
        'billboard-bp5' => __( 'Billboard', 'derioolkrak' ),
    ) );
}
...
//require_once( 'functions-inc/derioolkrak-settings.php' );
...
function webbird_sidebar_default() {
	...
	$args = array(
		'id'            => 'sidebar1',
		'name'          => __( 'Default', 'derioolkrak' ),
		'description'   => __( 'Default sidebar', 'derioolkrak' ),
...
function webbird_sidebar_footer_sidebar1() {
	...
	$args = array(
		'id'            => 'sidebar2',
		'name'          => __( 'Footer - Sidebar 1', 'derioolkrak' ),
		'description'   => __( 'Footer - Sidebar 1', 'derioolkrak' ),
		'class'         => 'sidebar-default',
		'before_widget' => '<div class="sidebar-default %2$s">',
		'after_widget'  => '</div>',
...
function webbird_sidebar_footer_sidebar2() {
	...
	$args = array(
		'id'            => 'sidebar3',
		'name'          => __( 'Footer - Sidebar 2', 'derioolkrak' ),
		'description'   => __( 'Footer - Sidebar 2', 'derioolkrak' ),
		'class'         => 'sidebar-default',
		'before_widget' => '<div class="sidebar-default %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widgettitle">',
...
// Register Sidebar
function webbird_sidebar_contact_sidebar1() {

	$args = array(
		'id'            => 'sidebar4',
		'name'          => __( 'Contact - Sidebar 1', 'derioolkrak' ),
		'description'   => __( 'Contact - Sidebar 1', 'derioolkrak' ),
		'class'         => 'sidebar-default',
		'before_widget' => '<div class="sidebar-default %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widgettitle">',
...
// Hook into the 'widgets_init' action
add_action( 'widgets_init', 'webbird_sidebar_contact_sidebar1' );
